...
export function MissionPage() {
  ...
  <style>
    ...
    .m-story .big{font-size:1.6rem;font-weight:800;color:var(--brand-dark);line-height:1.5;margin:40px 0}
    ...
    .m-val .vi{width:70px;height:70px;border-radius:50%;background:var(--brand-soft);color:var(--brand);display:grid;place-items:center;font-size:1.8rem;margin:0 auto 20px}
  ...
  <section class="section">
    <div class="wrap m-story">
      <div class="section-head reveal" style="text-align:left;margin-bottom:36px">
        <div class="kicker-line" style="margin:0 0 18px"></div>
        <h2 style="font-size:2rem">우리가 치과를 시작한 이유</h2>
      </div>
  ...
  <section class="section" style="background:var(--bg-cream)">
    <div class="wrap">
      <div class="section-head reveal">
        <div class="kicker-line"></div><span class="eyebrow">Core Values</span>
        <h2>이솔치과의 약속</h2>
      </div>
      <div class="m-values">
  ...
  <section class="section">
    <div class="wrap" style="text-align:center">
      <div class="reveal" style="background:linear-gradient(135deg,var(--brand),var(--brand-light));color:#fff;border-radius:var(--radius-lg);padding:64px 32px">
...
export function DirectionsPage() {
  ...
  <style>
    ...
    .dir-info .ri{width:48px;height:48px;border-radius:12px;background:var(--brand-soft);color:var(--brand);display:grid;place-items:center;font-size:1.2rem;flex:none}
    ...
    .hours-table td:first-child{font-weight:700;color:var(--brand-dark)}
    ...
    <div class="wrap">
      <div class="dir-grid">
        <div class="dir-info reveal">
          ...
          <div class="row"><div class="ri"><i class="fas fa-phone"></i></div><div><div class="rt">대표전화</div><div class="rd"><a href="tel:${CLINIC.tel}" style="color:var(--brand);font-weight:700">${CLINIC.tel}</a></div></div></div>
        ...
        <div class="reveal reveal-d1">
          <div class="map-box">
            <div>
              <i class="fas fa-map-marked-alt" style="font-size:3rem;color:var(--brand-light);margin-bottom:16px"></i>
          ...
          <h3 style="font-size:1.3rem;margin:32px 0 4px"><i class="fas fa-clock" style="color:var(--brand);margin-right:8px"></i>진료시간</h3>
...
export function FaqPage() {
  ...
  <style>
    ...
    .faq-cat h2{font-size:1.5rem;color:var(--brand-dark);margin-bottom:20px;display:flex;align-items:center;gap:12px}
    .faq-cat h2 i{color:var(--brand)}
    ...
    .faq-item summary i{color:var(--brand);transition:transform .3s}
    ...
    <div class="wrap" style="max-width:880px">
      ${raw(TREATMENTS.map(t => `
        <div class="faq-cat reveal">
          ...
          <a href="/treatments/${t.slug}" style="display:inline-block;margin-top:8px;color:var(--brand);font-weight:700;font-size:.9rem">${t.name} 자세히 보기 <i class="fas fa-arrow-right"></i></a>
        </div>`).join(''))}
    </div>
  </section>
  `;
...
export function PricingPage() {
  ...
  <section class="section">
    <div class="wrap" style="max-width:780px">
      <div class="reveal" style="background:var(--brand-soft);border-left:4px solid var(--brand);padding:28px 32px;border-radius:0 var(--radius) var(--radius) 0;margin-bottom:36px">
      ...
      <div class="reveal reveal-d1" style="text-align:center;padding:48px;background:var(--bg-cream);border-radius:var(--radius-lg)">
        <i class="fas fa-comments" style="font-size:2.5rem;color:var(--brand-light);margin-bottom:16px"></i>
...
export function ReservationPage() {
  ...
  <style>
    ...
    .res-form input:focus,.res-form select:focus,.res-form textarea:focus{outline:none;border-color:var(--brand)}
    ...
    .res-side{background:var(--brand-dark);color:#fff;border-radius:var(--radius-lg);padding:40px}
    ...
    .res-side .si i{color:var(--accent);font-size:1.2rem;width:24px}
    .res-msg{padding:14px 18px;border-radius:12px;margin-top:16px;display:none;font-weight:600}
    .res-msg.ok{display:block;background:var(--brand-soft);color:var(--brand-dark)}
...
export function CasesPage() {
  ...
  <section class="section">
    <div class="wrap" style="max-width:720px;text-align:center">
      <div class="reveal" style="padding:56px 40px;background:var(--bg-cream);border-radius:var(--radius-lg)">
        <i class="fas fa-lock" style="font-size:2.6rem;color:var(--brand-light);margin-bottom:20px"></i>
...
export function AreaPage(area: { slug: string; name: string; full: string }, t: Treatment) {
  ...
  <style>
    ...
    .area-body h2{font-size:1.5rem;color:var(--brand-dark);margin:36px 0 14px;padding-left:16px;position:relative}
    .area-body h2::before{content:'';position:absolute;left:0;top:4px;bottom:4px;width:5px;background:var(--accent);border-radius:3px}
    .area-body p{color:var(--ink-soft);line-height:1.85;font-size:1.05rem}
  </style>
  <section class="section">
    <div class="wrap area-body">
      <div class="reveal" style="background:var(--brand-soft);border-radius:var(--radius);padding:24px 28px;margin-bottom:32px">
      ...
      <div style="text-align:center;margin-top:48px;background:var(--brand);color:#fff;border-radius:var(--radius-lg);padding:48px">
...
export function NotFoundPage() {
  return html`
  <section style="min-height:80vh;display:flex;align-items:center;justify-content:center;background:var(--bg-cream);text-align:center;padding:120px 20px 60px">
    <div>
      <div style="font-size:6rem;font-weight:800;color:var(--brand);line-height:1">404</div>
