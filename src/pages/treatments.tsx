...
.t-hero::before{content:'';position:absolute;inset:0;background:radial-gradient(700px 460px at 82% 20%,rgba(200,119,90,.16),transparent 60%)}
...
.t-cta::before{content:'';position:absolute;inset:0;background:radial-gradient(500px 320px at 50% 0%,rgba(200,119,90,.2),transparent 60%)}
